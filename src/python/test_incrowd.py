...
from incrowd import ConvolutionalInCrowdModel, InCrowd, fast_conv
...
def test1():
    ...
    time_lags = np.arange(0, 5, 1, dtype='int')
    ...
    cic_model = ConvolutionalInCrowdModel(stim, output, len(time_lags), bias=0.0)
